...
| F3          | Area Atributes                        | Key Press: Cycle area attribute types. Right Click: Select area. Left Click: Apply attribute                                           |
| F4          | Add Ladders                           | Key Press: Auto, manual create, flip. Right Click: Select Area                                     |
| F5          | Test Nav Paths                        | Cycle path-finding test modes. Right Click: Select final area. Left Click: start test from current locaiton              |
| F6          | Ajust Area Height						          | Cycle through area height changes (Options: 1/10/100/fix to ground) (Left/Right Click: Select Area, Mouse Wheel: raise/lower)   |
